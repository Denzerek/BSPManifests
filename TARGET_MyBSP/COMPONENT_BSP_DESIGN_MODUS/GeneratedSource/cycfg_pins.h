...
#define CYBSP_LED_RGB_RED_PORT_NUM 0U
...
#define CYBSP_LED_RGB_RED_NUM 3U
#define CYBSP_USER_LED3_NUM CYBSP_LED_RGB_RED_NUM
#define CYBSP_LED_RGB_RED_DRIVEMODE CY_GPIO_DM_ANALOG
#define CYBSP_USER_LED3_DRIVEMODE CYBSP_LED_RGB_RED_DRIVEMODE
#define CYBSP_LED_RGB_RED_INIT_DRIVESTATE 1
...
#endif
#define CYBSP_LED_RGB_RED_HSIOM ioss_0_port_0_pin_3_HSIOM
#define CYBSP_USER_LED3_HSIOM CYBSP_LED_RGB_RED_HSIOM
#define CYBSP_LED_RGB_RED_IRQ ioss_interrupts_gpio_0_IRQn
#define CYBSP_USER_LED3_IRQ CYBSP_LED_RGB_RED_IRQ
#if defined (CY_USING_HAL)
    #define CYBSP_LED_RGB_RED_HAL_PORT_PIN P0_3
    #define CYBSP_USER_LED3_HAL_PORT_PIN CYBSP_LED_RGB_RED_HAL_PORT_PIN
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
...
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    #define CYBSP_LED_RGB_RED_HAL_IRQ CYHAL_GPIO_IRQ_NONE
    #define CYBSP_USER_LED3_HAL_IRQ CYBSP_LED_RGB_RED_HAL_IRQ
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    #define CYBSP_LED_RGB_RED_HAL_DIR CYHAL_GPIO_DIR_INPUT 
    #define CYBSP_USER_LED3_HAL_DIR CYBSP_LED_RGB_RED_HAL_DIR
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    #define CYBSP_LED_RGB_RED_HAL_DRIVEMODE CYHAL_GPIO_DRIVE_ANALOG
    #define CYBSP_USER_LED3_HAL_DRIVEMODE CYBSP_LED_RGB_RED_HAL_DRIVEMODE
#endif //defined (CY_USING_HAL)
...
#define CYBSP_SW2_DRIVEMODE CY_GPIO_DM_ANALOG
...
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    #define CYBSP_SW2_HAL_DRIVEMODE CYHAL_GPIO_DRIVE_ANALOG
...
#define CYBSP_LED_RGB_BLUE_PORT_NUM 11U
...
#define CYBSP_LED_RGB_BLUE_NUM 1U
...
#endif
#define CYBSP_LED_RGB_BLUE_HSIOM ioss_0_port_11_pin_1_HSIOM
#define CYBSP_USER_LED5_HSIOM CYBSP_LED_RGB_BLUE_HSIOM
#define CYBSP_LED_RGB_BLUE_IRQ ioss_interrupts_gpio_11_IRQn
#define CYBSP_USER_LED5_IRQ CYBSP_LED_RGB_BLUE_IRQ
#if defined (CY_USING_HAL)
    #define CYBSP_LED_RGB_BLUE_HAL_PORT_PIN P11_1
...
#define CYBSP_USER_LED2_ENABLED CYBSP_LED9_ENABLED
#define CYBSP_J2_20_ENABLED CYBSP_LED9_ENABLED
#define CYBSP_LED9_PORT GPIO_PRT13
#define CYBSP_USER_LED2_PORT CYBSP_LED9_PORT
#define CYBSP_J2_20_PORT CYBSP_LED9_PORT
#define CYBSP_LED9_PORT_NUM 13U
#define CYBSP_USER_LED2_PORT_NUM CYBSP_LED9_PORT_NUM
#define CYBSP_J2_20_PORT_NUM CYBSP_LED9_PORT_NUM
#define CYBSP_LED9_PIN 7U
#define CYBSP_USER_LED2_PIN CYBSP_LED9_PIN
#define CYBSP_J2_20_PIN CYBSP_LED9_PIN
#define CYBSP_LED9_NUM 7U
#define CYBSP_USER_LED2_NUM CYBSP_LED9_NUM
#define CYBSP_J2_20_NUM CYBSP_LED9_NUM
#define CYBSP_LED9_DRIVEMODE CY_GPIO_DM_ANALOG
#define CYBSP_USER_LED2_DRIVEMODE CYBSP_LED9_DRIVEMODE
#define CYBSP_J2_20_DRIVEMODE CYBSP_LED9_DRIVEMODE
#define CYBSP_LED9_INIT_DRIVESTATE 1
#define CYBSP_USER_LED2_INIT_DRIVESTATE CYBSP_LED9_INIT_DRIVESTATE
#define CYBSP_J2_20_INIT_DRIVESTATE CYBSP_LED9_INIT_DRIVESTATE
...
#define CYBSP_USER_LED2_HSIOM CYBSP_LED9_HSIOM
#define CYBSP_J2_20_HSIOM CYBSP_LED9_HSIOM
#define CYBSP_LED9_IRQ ioss_interrupts_gpio_13_IRQn
#define CYBSP_USER_LED2_IRQ CYBSP_LED9_IRQ
#define CYBSP_J2_20_IRQ CYBSP_LED9_IRQ
#if defined (CY_USING_HAL)
    #define CYBSP_LED9_HAL_PORT_PIN P13_7
    #define CYBSP_USER_LED2_HAL_PORT_PIN CYBSP_LED9_HAL_PORT_PIN
    #define CYBSP_J2_20_HAL_PORT_PIN CYBSP_LED9_HAL_PORT_PIN
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    ...
    #define CYBSP_USER_LED2_HAL_IRQ CYBSP_LED9_HAL_IRQ
    #define CYBSP_J2_20_HAL_IRQ CYBSP_LED9_HAL_IRQ
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    #define CYBSP_LED9_HAL_DIR CYHAL_GPIO_DIR_INPUT 
    #define CYBSP_USER_LED2_HAL_DIR CYBSP_LED9_HAL_DIR
    #define CYBSP_J2_20_HAL_DIR CYBSP_LED9_HAL_DIR
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    #define CYBSP_LED9_HAL_DRIVEMODE CYHAL_GPIO_DRIVE_ANALOG
    #define CYBSP_USER_LED2_HAL_DRIVEMODE CYBSP_LED9_HAL_DRIVEMODE
    #define CYBSP_J2_20_HAL_DRIVEMODE CYBSP_LED9_HAL_DRIVEMODE
#endif //defined (CY_USING_HAL)
...
#define CYBSP_USER_LED4_ENABLED CYBSP_LED_RGB_GREEN_ENABLED
#define CYBSP_LED_RGB_GREEN_PORT GPIO_PRT1
#define CYBSP_USER_LED4_PORT CYBSP_LED_RGB_GREEN_PORT
#define CYBSP_LED_RGB_GREEN_PORT_NUM 1U
#define CYBSP_USER_LED4_PORT_NUM CYBSP_LED_RGB_GREEN_PORT_NUM
#define CYBSP_LED_RGB_GREEN_PIN 1U
#define CYBSP_USER_LED4_PIN CYBSP_LED_RGB_GREEN_PIN
#define CYBSP_LED_RGB_GREEN_NUM 1U
#define CYBSP_USER_LED4_NUM CYBSP_LED_RGB_GREEN_NUM
#define CYBSP_LED_RGB_GREEN_DRIVEMODE CY_GPIO_DM_ANALOG
#define CYBSP_USER_LED4_DRIVEMODE CYBSP_LED_RGB_GREEN_DRIVEMODE
#define CYBSP_LED_RGB_GREEN_INIT_DRIVESTATE 1
#define CYBSP_USER_LED4_INIT_DRIVESTATE CYBSP_LED_RGB_GREEN_INIT_DRIVESTATE
#ifndef ioss_0_port_1_pin_1_HSIOM
    #define ioss_0_port_1_pin_1_HSIOM HSIOM_SEL_GPIO
#endif
#define CYBSP_LED_RGB_GREEN_HSIOM ioss_0_port_1_pin_1_HSIOM
#define CYBSP_USER_LED4_HSIOM CYBSP_LED_RGB_GREEN_HSIOM
#define CYBSP_LED_RGB_GREEN_IRQ ioss_interrupts_gpio_1_IRQn
#define CYBSP_USER_LED4_IRQ CYBSP_LED_RGB_GREEN_IRQ
#if defined (CY_USING_HAL)
    #define CYBSP_LED_RGB_GREEN_HAL_PORT_PIN P1_1
    #define CYBSP_USER_LED4_HAL_PORT_PIN CYBSP_LED_RGB_GREEN_HAL_PORT_PIN
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
...
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    #define CYBSP_LED_RGB_GREEN_HAL_IRQ CYHAL_GPIO_IRQ_NONE
    #define CYBSP_USER_LED4_HAL_IRQ CYBSP_LED_RGB_GREEN_HAL_IRQ
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    #define CYBSP_LED_RGB_GREEN_HAL_DIR CYHAL_GPIO_DIR_INPUT 
    #define CYBSP_USER_LED4_HAL_DIR CYBSP_LED_RGB_GREEN_HAL_DIR
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    #define CYBSP_LED_RGB_GREEN_HAL_DRIVEMODE CYHAL_GPIO_DRIVE_ANALOG
    #define CYBSP_USER_LED4_HAL_DRIVEMODE CYBSP_LED_RGB_GREEN_HAL_DRIVEMODE
#endif //defined (CY_USING_HAL)
#define CYBSP_LED8_ENABLED 1U
#define CYBSP_USER_LED_ENABLED CYBSP_LED8_ENABLED
#define CYBSP_USER_LED1_ENABLED CYBSP_LED8_ENABLED
#define CYBSP_LED8_PORT GPIO_PRT1
#define CYBSP_USER_LED_PORT CYBSP_LED8_PORT
#define CYBSP_USER_LED1_PORT CYBSP_LED8_PORT
#define CYBSP_LED8_PORT_NUM 1U
#define CYBSP_USER_LED_PORT_NUM CYBSP_LED8_PORT_NUM
#define CYBSP_USER_LED1_PORT_NUM CYBSP_LED8_PORT_NUM
#define CYBSP_LED8_PIN 5U
#define CYBSP_USER_LED_PIN CYBSP_LED8_PIN
#define CYBSP_USER_LED1_PIN CYBSP_LED8_PIN
#define CYBSP_LED8_NUM 5U
#define CYBSP_USER_LED_NUM CYBSP_LED8_NUM
#define CYBSP_USER_LED1_NUM CYBSP_LED8_NUM
#define CYBSP_LED8_DRIVEMODE CY_GPIO_DM_ANALOG
#define CYBSP_USER_LED_DRIVEMODE CYBSP_LED8_DRIVEMODE
#define CYBSP_USER_LED1_DRIVEMODE CYBSP_LED8_DRIVEMODE
#define CYBSP_LED8_INIT_DRIVESTATE 1
#define CYBSP_USER_LED_INIT_DRIVESTATE CYBSP_LED8_INIT_DRIVESTATE
#define CYBSP_USER_LED1_INIT_DRIVESTATE CYBSP_LED8_INIT_DRIVESTATE
...
#define CYBSP_USER_LED_HSIOM CYBSP_LED8_HSIOM
#define CYBSP_USER_LED1_HSIOM CYBSP_LED8_HSIOM
#define CYBSP_LED8_IRQ ioss_interrupts_gpio_1_IRQn
#define CYBSP_USER_LED_IRQ CYBSP_LED8_IRQ
#define CYBSP_USER_LED1_IRQ CYBSP_LED8_IRQ
#if defined (CY_USING_HAL)
    #define CYBSP_LED8_HAL_PORT_PIN P1_5
    #define CYBSP_USER_LED_HAL_PORT_PIN CYBSP_LED8_HAL_PORT_PIN
    #define CYBSP_USER_LED1_HAL_PORT_PIN CYBSP_LED8_HAL_PORT_PIN
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    ...
    #define CYBSP_USER_LED_HAL_IRQ CYBSP_LED8_HAL_IRQ
    #define CYBSP_USER_LED1_HAL_IRQ CYBSP_LED8_HAL_IRQ
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    #define CYBSP_LED8_HAL_DIR CYHAL_GPIO_DIR_INPUT 
    #define CYBSP_USER_LED_HAL_DIR CYBSP_LED8_HAL_DIR
    #define CYBSP_USER_LED1_HAL_DIR CYBSP_LED8_HAL_DIR
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    #define CYBSP_LED8_HAL_DRIVEMODE CYHAL_GPIO_DRIVE_ANALOG
    #define CYBSP_USER_LED_HAL_DRIVEMODE CYBSP_LED8_HAL_DRIVEMODE
    #define CYBSP_USER_LED1_HAL_DRIVEMODE CYBSP_LED8_HAL_DRIVEMODE
#endif //defined (CY_USING_HAL)
#define CYBSP_DEBUG_UART_RX_ENABLED 1U
#define CYBSP_D0_ENABLED CYBSP_DEBUG_UART_RX_ENABLED
#define CYBSP_DEBUG_UART_RX_PORT GPIO_PRT5
#define CYBSP_D0_PORT CYBSP_DEBUG_UART_RX_PORT
#define CYBSP_DEBUG_UART_RX_PORT_NUM 5U
#define CYBSP_D0_PORT_NUM CYBSP_DEBUG_UART_RX_PORT_NUM
#define CYBSP_DEBUG_UART_RX_PIN 0U
#define CYBSP_D0_PIN CYBSP_DEBUG_UART_RX_PIN
#define CYBSP_DEBUG_UART_RX_NUM 0U
#define CYBSP_D0_NUM CYBSP_DEBUG_UART_RX_NUM
#define CYBSP_DEBUG_UART_RX_DRIVEMODE CY_GPIO_DM_ANALOG
#define CYBSP_D0_DRIVEMODE CYBSP_DEBUG_UART_RX_DRIVEMODE
#define CYBSP_DEBUG_UART_RX_INIT_DRIVESTATE 1
#define CYBSP_D0_INIT_DRIVESTATE CYBSP_DEBUG_UART_RX_INIT_DRIVESTATE
#ifndef ioss_0_port_5_pin_0_HSIOM
    #define ioss_0_port_5_pin_0_HSIOM HSIOM_SEL_GPIO
#endif
#define CYBSP_DEBUG_UART_RX_HSIOM ioss_0_port_5_pin_0_HSIOM
#define CYBSP_D0_HSIOM CYBSP_DEBUG_UART_RX_HSIOM
#define CYBSP_DEBUG_UART_RX_IRQ ioss_interrupts_gpio_5_IRQn
#define CYBSP_D0_IRQ CYBSP_DEBUG_UART_RX_IRQ
#if defined (CY_USING_HAL)
    #define CYBSP_DEBUG_UART_RX_HAL_PORT_PIN P5_0
    #define CYBSP_D0_HAL_PORT_PIN CYBSP_DEBUG_UART_RX_HAL_PORT_PIN
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    ...
    #define CYBSP_D0_HAL_IRQ CYBSP_DEBUG_UART_RX_HAL_IRQ
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    #define CYBSP_DEBUG_UART_RX_HAL_DIR CYHAL_GPIO_DIR_INPUT 
    #define CYBSP_D0_HAL_DIR CYBSP_DEBUG_UART_RX_HAL_DIR
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    #define CYBSP_DEBUG_UART_RX_HAL_DRIVEMODE CYHAL_GPIO_DRIVE_ANALOG
    #define CYBSP_D0_HAL_DRIVEMODE CYBSP_DEBUG_UART_RX_HAL_DRIVEMODE
#endif //defined (CY_USING_HAL)
#define CYBSP_DEBUG_UART_TX_ENABLED 1U
#define CYBSP_D1_ENABLED CYBSP_DEBUG_UART_TX_ENABLED
#define CYBSP_DEBUG_UART_TX_PORT GPIO_PRT5
#define CYBSP_D1_PORT CYBSP_DEBUG_UART_TX_PORT
#define CYBSP_DEBUG_UART_TX_PORT_NUM 5U
#define CYBSP_D1_PORT_NUM CYBSP_DEBUG_UART_TX_PORT_NUM
#define CYBSP_DEBUG_UART_TX_PIN 1U
#define CYBSP_D1_PIN CYBSP_DEBUG_UART_TX_PIN
#define CYBSP_DEBUG_UART_TX_NUM 1U
#define CYBSP_D1_NUM CYBSP_DEBUG_UART_TX_NUM
#define CYBSP_DEBUG_UART_TX_DRIVEMODE CY_GPIO_DM_ANALOG
#define CYBSP_D1_DRIVEMODE CYBSP_DEBUG_UART_TX_DRIVEMODE
#define CYBSP_DEBUG_UART_TX_INIT_DRIVESTATE 1
#define CYBSP_D1_INIT_DRIVESTATE CYBSP_DEBUG_UART_TX_INIT_DRIVESTATE
#ifndef ioss_0_port_5_pin_1_HSIOM
    #define ioss_0_port_5_pin_1_HSIOM HSIOM_SEL_GPIO
#endif
#define CYBSP_DEBUG_UART_TX_HSIOM ioss_0_port_5_pin_1_HSIOM
#define CYBSP_D1_HSIOM CYBSP_DEBUG_UART_TX_HSIOM
#define CYBSP_DEBUG_UART_TX_IRQ ioss_interrupts_gpio_5_IRQn
#define CYBSP_D1_IRQ CYBSP_DEBUG_UART_TX_IRQ
#if defined (CY_USING_HAL)
    #define CYBSP_DEBUG_UART_TX_HAL_PORT_PIN P5_1
    #define CYBSP_D1_HAL_PORT_PIN CYBSP_DEBUG_UART_TX_HAL_PORT_PIN
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    ...
    #define CYBSP_D1_HAL_IRQ CYBSP_DEBUG_UART_TX_HAL_IRQ
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    #define CYBSP_DEBUG_UART_TX_HAL_DIR CYHAL_GPIO_DIR_INPUT 
    #define CYBSP_D1_HAL_DIR CYBSP_DEBUG_UART_TX_HAL_DIR
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
    #define CYBSP_DEBUG_UART_TX_HAL_DRIVEMODE CYHAL_GPIO_DRIVE_ANALOG
    #define CYBSP_D1_HAL_DRIVEMODE CYBSP_DEBUG_UART_TX_HAL_DRIVEMODE
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
...
#if defined (CY_USING_HAL)
    extern const cyhal_resource_inst_t CYBSP_LED_RGB_RED_obj;
    #define CYBSP_USER_LED3_obj CYBSP_LED_RGB_RED_obj
#endif //defined (CY_USING_HAL)
...
#define CYBSP_USER_LED2_config CYBSP_LED9_config
#define CYBSP_J2_20_config CYBSP_LED9_config
#if defined (CY_USING_HAL)
    extern const cyhal_resource_inst_t CYBSP_LED9_obj;
    #define CYBSP_USER_LED2_obj CYBSP_LED9_obj
    #define CYBSP_J2_20_obj CYBSP_LED9_obj
#endif //defined (CY_USING_HAL)
...
#if defined (CY_USING_HAL)
    extern const cyhal_resource_inst_t CYBSP_LED_RGB_GREEN_obj;
    #define CYBSP_USER_LED4_obj CYBSP_LED_RGB_GREEN_obj
#endif //defined (CY_USING_HAL)
extern const cy_stc_gpio_pin_config_t CYBSP_LED8_config;
#define CYBSP_USER_LED_config CYBSP_LED8_config
#define CYBSP_USER_LED1_config CYBSP_LED8_config
#if defined (CY_USING_HAL)
    extern const cyhal_resource_inst_t CYBSP_LED8_obj;
    #define CYBSP_USER_LED_obj CYBSP_LED8_obj
    #define CYBSP_USER_LED1_obj CYBSP_LED8_obj
#endif //defined (CY_USING_HAL)
extern const cy_stc_gpio_pin_config_t CYBSP_DEBUG_UART_RX_config;
#define CYBSP_D0_config CYBSP_DEBUG_UART_RX_config
#if defined (CY_USING_HAL)
    extern const cyhal_resource_inst_t CYBSP_DEBUG_UART_RX_obj;
    #define CYBSP_D0_obj CYBSP_DEBUG_UART_RX_obj
#endif //defined (CY_USING_HAL)
extern const cy_stc_gpio_pin_config_t CYBSP_DEBUG_UART_TX_config;
#define CYBSP_D1_config CYBSP_DEBUG_UART_TX_config
#if defined (CY_USING_HAL)
    extern const cyhal_resource_inst_t CYBSP_DEBUG_UART_TX_obj;
    #define CYBSP_D1_obj CYBSP_DEBUG_UART_TX_obj
#endif //defined (CY_USING_HAL)
